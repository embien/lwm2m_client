...
#define	FIXED_INTBITS		18
#define	FIXED_FRACBITS		13
...
#define	FIXED_INVALID_NUM	0xFFFFFFFF

#define MAX_FP_POS_RANGE    0x7fffe000
#define MAX_FP_NEG_RANGE    0x80002000

#define MAX_FP_NEG          0x80000000
...
#define FRACTION_ADD(res, x, y)   res = ((x) + (y))
#define FRACTION_SUB(res, x, y)   res = ((x) - (y))
...
#define _short2q(x, fb)			((fixedp)((x) << (fb)))
     ...
     * 
     */
    #define _qmul(x, y, xFb, yFb, resFb) ((INT32S)(((long long)(x) * (long long)(y)) >> ((xFb) + (yFb) - (resFb)))) //fixedp
     ...
     */
    #define _qdiv(x, y, xFb, yFb, resFb) ((INT32S)((((long long)x) << ((xFb) + (yFb) - (resFb))) / y))  //fixedp
...
extern FRACTION  str_to_float (INT8U * , int );
#endif
